                    ...
                    <div class="addProducto">                     
                        ...
                        <div class="card cardespa">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-7">
                                        <h5>Lista de Productos ha enviar</h5>
                                    </div>
                                    <div class="col-5">
                            ...
                            <div class="card-body">                
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody id="myTable" >
                                        <c:forEach var="productoPendiente" items="${sessionScope.productoPendiente}">
                                            <tr>
                                                <td>${productoPendiente.nombreCompleto}</td>
                                                <td>${productoPendiente.fechaVenta}</td>
                                                <td>S/.${productoPendiente.totalPagar}</td>
                                                <td>${productoPendiente.destino}</td>
                                                <td>${productoPendiente.direccion}</td>
                                                <td>${productoPendiente.estado}</td>
                                                <td>
                                                    <a class="btn btn-warning btn-sm" href="<%=request.getContextPath()%>/comproducto.do?txtAccion=detalleVentaProducto&txtIdVenta=${productoPendiente.idVenta}"><i class="far fa-edit"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
