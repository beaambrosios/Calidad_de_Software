...
$(function () {
    $('#chkAceptar').click(function (e){
        Swal.fire({
            title: "Esta Seguro de Editar?",
            text: "Una vez Editado deberá agregar de nuevo!",
            icon: "warning",
            showCancelButton: true,
            confirmButtonClass: "btn-danger",
            ...
            if (result.isConfirmed) {
               $.ajax({
                   ...
                   async: true,
                    success: function () {
                        Swal.fire("Editado!", "El usuario se ha Editado", "success");
                        setTimeout(function (){
                        parent.location.href = "comproducto.do?txtAccion=listProducto"
                        }, 2800);
                        alertify.success(' Producto Eliminado');
                    }
                }); 
            } else if (result.dismiss === Swal.DismissReason.cancel){
                        Swal.fire("Cancelado", "Cancelaste Editar", "error");
                }
